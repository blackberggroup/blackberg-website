...
const AboutSection = () => {
    ...
    return (
        <section id="home-about-section" className="container-fluid py-8 py-md-11" aria-label="About Overview">
            <div className="container position-relative">
                ...
                <div className="row mt-4 d-flex position-relative">
                    ...
                    <div className="col-12 col-md-10 col-lg-7 offset-md-2 ml-auto pt-4 pt-lg-10 position-relative">
