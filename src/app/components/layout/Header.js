...
const Header = ({ nav, props }) => {
  const { simpleHeader = false, navStyle = "", cta = {} } = props || {};
  ...
  const defaultCta = {
    ...
    id: "header-schedule-discovery-call",
    target: "_blank",
  };
            ...
            <>
              ...
              <div className="d-flex">
                <Link
                  ...
                  target={finalCta.target}
                  rel={finalCta.target === "_blank" ? "noopener noreferrer" : undefined}
                >
                  <span className="d-none d-lg-inline">{finalCta.label}</span>
                  <span className="d-inline d-lg-none" aria-hidden="true">
                    {/* phone glyph */}
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
