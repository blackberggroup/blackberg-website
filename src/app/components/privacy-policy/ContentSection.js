...
const ContentSection = () => {
    ...
    return (
            <section id="content-section" className="py-8 py-md-11 position-relative z-1">
                <div className="container">
                    <div className="row align-items-center justify-content-center">
                        <div className="col-12">
                            ...
                            <li>
                                <p>
                                <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Blackberg Group, LLC, Norfolk, VA.
                                </p>
                            </li>
                            <li>
                                <p>
                            ...
                            <li>
                                <p>
                                <strong>Website</strong> refers to Blackberg Group, LLC, accessible from <Link href="https://www.blackberggroup.com" rel="external nofollow noopener">https://www.blackberggroup.com</Link>
                                </p>
                            </li>
                            <li>
                                <p>
                            ...
                            <p>We may also collect information that Your browser sends wrhenever You visit our Service or when You access the Service by or through a mobile device.</p>
                            ...
                            <ul>
                            <li>By email: <Link href="mailto:support@blackberggroup.com">support@blackberggroup.com</Link></li>
                            </ul>
                        </div>                        
                    </div>
                </div>
