...
const DigitalCapabilities = () => {
  ...
  return (
    <section id="" className="py-8 py-lg-10">
      <div className="container">
        <div className="row">
          <div className="col-12">
            <h2 ref={titleRef} className="display-5 mb-5 section-title">Our Digital Services</h2>
          </div>
        </div>
        <div className="row">
          ...
          <div ref={col3Ref} className="col-12 col-lg-4 mb-4 mb-md-5 column-events">
            ...
            <p>We provide data integration services that unify disparate data sources into a cohesive, secure platform, enabling seamless access and real-time insights for clients. By leveraging AI-driven data mapping and transformation, we enhance interoperability and accelerate decision-making across complex systems.</p>
          </div>
