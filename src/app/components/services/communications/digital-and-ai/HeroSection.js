...
const HeroSection = () => {
  ...
  return (
    <section id="digital-ai-hero">
          ...
          <div className="row align-items-center h-100">
            <div className="col-12 col-md-10 offset-md-1">
              <div className="hero-title text-center">
                <div className="d-inline-flex rounded-50 px-2 align-items-center text-secondary border border-secondary text-figtree">
                  <img src="/images/ai-powered-solutions.svg" />
                  <span>AI-Powered Solutions</span>
                </div>
                <h1 ref={headlineRef} className="display-4 hero-title__headline text-white my-3 my-lg-5">
                  Modern Web Design & <br />AI-Powered <br /><span className="gradient-text">Development</span>
                </h1>
                <p ref={subRef} className="hero-title__subheadline lead text-white mb-6 w-75 mx-auto">
                  Modern, user-focused web experiences that drive engagement and measurable results. Built for government, nonprofits, and mission-driven organizations.
                </p>
                <Link
                  href="#"
                  className="btn btn-white bg-white hero__btn"
      ...
      <img src="/images/ai-circle.svg" className="position-absolute grid-pattern img-fluid" />
      </div>
    </section>
  );
};
