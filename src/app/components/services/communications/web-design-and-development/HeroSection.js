            ...
            <div className="col-12 col-md-10 offset-md-1">
              <div className="hero-title text-center">
                <h1 ref={headlineRef} className="display-2 hero-title__headline text-white mb-3 mb-lg-5">
                  Modern Web Design & AI-Powered Development
                </h1>
                <p ref={subRef} className="hero-title__subheadline lead text-white mb-6">
                  Modern, user-focused web experiences that drive engagement and measurable results. <br />Built for government, nonprofits, and mission-driven organizations.
                </p>
                <Link
                  href="#"
