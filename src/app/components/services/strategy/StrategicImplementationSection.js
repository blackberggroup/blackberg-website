...
const StrategicImplementationSection = () => {
    useEffect(() => {
        ...
        gsap.to('.strategic-implementation__circles', {
            scale: 3.5,
            scrollTrigger: {
                trigger: '#strategy-strategic-implementation',
                start: 'top center',
                end: 'bottom center',
                scrub: true
            }
        ...
        <section id="strategy-strategic-implementation" className="py-8 py-md-11">
            <div className="container">
                ...
                <div className="col-12 col-lg-8 offset-lg-2">
                        <p>As part of our implementation, Blackberg develops and deploys dashboard tools that offer executives with continuous monitoring of their strategy’s progress. We customize views to your unique strategic goals and performance measurements.</p>
                    </div>
                </div>                
            </div>
        </section>
